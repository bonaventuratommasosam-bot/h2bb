...
async function refreshMarketSnapshot(force = false) {
  ...
  try {
    ...
    // DO NOT write strategy.lastDecision from market snapshot.
    // lastDecision = engine trade intent only. Showcase uses signalLive from live score.
    // Keep a non-authoritative market view on the snapshot for debugging.
    snapshot.marketView = {
      bias: entryScore.bias,
      score: entryScore.score,
